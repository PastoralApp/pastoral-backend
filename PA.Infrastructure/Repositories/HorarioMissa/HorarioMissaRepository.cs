...
public class HorarioMissaRepository : IHorarioMissaRepository
{
    ...
    public async Task<IEnumerable<HorarioMissa>> GetByIgrejaAsync(Guid igrejaId, bool incluirInativos = false)
    {
        var query = _context.HorariosMissas
            .Include(h => h.Igreja)
    ...
    {
        return await GetByIgrejaAsync(igrejaId, incluirInativos);
    }
